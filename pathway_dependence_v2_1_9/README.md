...
Accompanying reproducibility package, version 2.1.9. Contents include graph
...
The command invokes 61 core/weight regression tests, eight theory-extension
...
run all 1,024 diffusion solves by default. Success is reported as:
    ...
    Pathway-dependence certificates v2.1.9 verification passed
...
CITATION.cff supplies author metadata for version 2.1.9. The versioned release is
https://github.com/ppy17136/multi-fidelity-cfd-estimability-resolvability/releases/tag/v2.1.9.
The earlier CFD mapping data are version 1.3.0, DOI
